...
class DashboardViewModel(QObject):
    ...
    def refresh(self) -> None:
        ...
        self._summary_cards = [
            {'title': 'Episodios', 'value': str(self.episode_repository.count()), 'hint': 'Sesiones capturadas y listas para revisar'},
            {'title': 'Conocimiento', 'value': str(self.knowledge_repository.count()), 'hint': 'Memoria confirmada para reutilizacion'},
            {'title': 'Ejecuciones', 'value': str(self.run_repository.count()), 'hint': 'Respuestas por rol ya registradas'},
