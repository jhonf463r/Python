...
Generado: 2026-05-08T17:41:42.266783+00:00
Resumen: Autoexaminacion watch: 12 hallazgos activos. Lo mas fuerte ahora es bootstrap init lento: 7422ms. Mejoras validadas: 0 | issues recurrentes: 5.
...
## Hallazgos
- Bootstrap init lento: 7422ms: El paso bootstrap_init_start->bootstrap_init_done duro 7422ms (umbral 4000ms). Esto retiene el GUI thread antes de que aparezca el splash.  [observado: 7422.0ms, umbral: 4000.0ms] | recomendacion: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | confianza 0.90
- RAM bajo presion: 2.9GB libre: 2.9GB de RAM disponible. Solo modelos pequenos caben. | recomendacion: Considerar liberar RAM si se necesita un modelo mas grande | confianza 0.90
...
- Bootstrap init lento: 7422ms: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | fuente data/logs/startup_timeline.jsonl, iabv_v15.infra.startup_timeline
- RAM bajo presion: 2.9GB libre: Considerar liberar RAM si se necesita un modelo mas grande | fuente n/d
