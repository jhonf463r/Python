...
Generado: 2026-05-09T19:15:48.643464+00:00
Resumen: Autoexaminacion watch: 11 hallazgos activos. Lo mas fuerte ahora es ram critica: 0.7gb libre de 15.7gb. Mejoras validadas: 0 | issues recurrentes: 5.
...
## Hallazgos
- RAM critica: 0.7GB libre de 15.7GB: Solo 0.7GB de RAM disponible. Modelos Ollama grandes no caben. Se recomienda liberar RAM cerrando procesos innecesarios. | recomendacion: Ejecutar liberacion automatica de RAM | confianza 0.95
- Bootstrap init lento: 7524ms: El paso bootstrap_init_start->bootstrap_init_done duro 7524ms (umbral 4000ms). Esto retiene el GUI thread antes de que aparezca el splash.  [observado: 7523.5ms, umbral: 4000.0ms] | recomendacion: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | confianza 0.90
...
- RAM critica: 0.7GB libre de 15.7GB: Ejecutar liberacion automatica de RAM | fuente n/d
- Bootstrap init lento: 7524ms: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | fuente data/logs/startup_timeline.jsonl, iabv_v15.infra.startup_timeline
