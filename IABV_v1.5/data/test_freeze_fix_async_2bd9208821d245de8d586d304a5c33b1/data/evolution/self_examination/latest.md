...
Generado: 2026-05-09T03:00:26.216496+00:00
Resumen: Autoexaminacion needs_attention: 13 hallazgos activos. Lo mas fuerte ahora es bootstrap init lento: 9161ms. Mejoras validadas: 0 | issues recurrentes: 5.
...
## Hallazgos
- Bootstrap init lento: 9161ms: El paso bootstrap_init_start->bootstrap_init_done duro 9161ms (umbral 4000ms). Esto retiene el GUI thread antes de que aparezca el splash.  [observado: 9160.9ms, umbral: 4000.0ms] | recomendacion: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | confianza 0.90
- excessive_polling_threads: 6 hilos de polling activos: ['ui-bridge-server', 'ui-bridge-server', 'iabv-health_0', 'iabv-health_1', 'iabv-health_2', 'iabv-health_3']. Cada uno ejecuta scans periodicos que compiten por CPU y GIL. | recomendacion: Reducir frecuencia de scan: WorldModelService._DEFAULT_SCAN_INTERVAL de 18s a 45s para uso normal. Usar scan_interval_seconds=120 cuando la presion de recursos es alta. | confianza 0.90
...
- Bootstrap init lento: 9161ms: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | fuente data/logs/startup_timeline.jsonl, iabv_v15.infra.startup_timeline
