...
Generado: 2026-05-27T15:59:10.631569+00:00
Resumen: Autoexaminacion watch: 10 hallazgos activos. Lo mas fuerte ahora es bootstrap init lento: 6901ms. Mejoras validadas: 0 | issues recurrentes: 5.
...
## Hallazgos
- Bootstrap init lento: 6901ms: El paso bootstrap_init_start->bootstrap_init_done duro 6901ms (umbral 4000ms). Esto retiene el GUI thread antes de que aparezca el splash.  [observado: 6900.9ms, umbral: 4000.0ms] | recomendacion: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | confianza 0.90
...
- Bootstrap init lento: 6901ms: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | fuente data/logs/startup_timeline.jsonl, iabv_v15.infra.startup_timeline
