...
Generado: 2026-05-09T01:37:03.817799+00:00
...
- UI event loop stalls: 36 detected (worst 27957ms): Investigate blocking on main thread during phase "control_center_refresh_autonomy_dock". Consider moving heavy work to background threads or adding yield-to-event-loop calls. | fuente n/d
...
- UI event loop stalls: 34 detected (worst 258371ms): no_evidence | Todavia no hay suficiente evidencia posterior para juzgar si esta recomendacion sirvio o no. | siguiente paso: Mantenerla en observacion hasta tener mas corridas comparables.
