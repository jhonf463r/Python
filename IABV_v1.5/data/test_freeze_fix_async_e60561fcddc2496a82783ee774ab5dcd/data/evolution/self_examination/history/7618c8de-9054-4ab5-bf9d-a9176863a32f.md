...
Generado: 2026-05-09T21:30:25.036465+00:00
Resumen: Autoexaminacion watch: 10 hallazgos activos. Lo mas fuerte ahora es bootstrap init lento: 6654ms. Mejoras validadas: 1 | issues recurrentes: 5.
...
## Hallazgos
- Bootstrap init lento: 6654ms: El paso bootstrap_init_start->bootstrap_init_done duro 6654ms (umbral 4000ms). Esto retiene el GUI thread antes de que aparezca el splash.  [observado: 6653.8ms, umbral: 4000.0ms] | recomendacion: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | confianza 0.90
...
- Bootstrap init lento: 6654ms: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | fuente data/logs/startup_timeline.jsonl, iabv_v15.infra.startup_timeline
