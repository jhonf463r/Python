...
Generado: 2026-05-25T15:41:39.967528+00:00
Resumen: Autoexaminacion needs_attention: 12 hallazgos activos. Lo mas fuerte ahora es bootstrap init lento: 12254ms. Mejoras validadas: 1 | issues recurrentes: 5.
...
## Hallazgos
- Bootstrap init lento: 12254ms: El paso bootstrap_init_start->bootstrap_init_done duro 12254ms (umbral 4000ms). Esto retiene el GUI thread antes de que aparezca el splash.  [observado: 12254.4ms, umbral: 4000.0ms] | recomendacion: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | confianza 0.90
- RAM critica: 1.6GB libre de 15.7GB: Solo 1.6GB de RAM disponible. Modelos Ollama grandes no caben. Se recomienda liberar RAM cerrando procesos innecesarios. | recomendacion: Ejecutar liberacion automatica de RAM | confianza 0.95
...
- Bootstrap init lento: 12254ms: Diferir scans de cuentas, instalacion de mcp_client y probes de proveedores de bootstrap.__init__ a un QTimer post-show. Patron ya aplicado a _log_tool_availability en PR #257. | fuente data/logs/startup_timeline.jsonl, iabv_v15.infra.startup_timeline
- RAM critica: 1.6GB libre de 15.7GB: Ejecutar liberacion automatica de RAM | fuente n/d
