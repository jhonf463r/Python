# Consolidación de Re-calibración Real

**Fecha:** 2026-06-18
**Objetivo:** Consolidar métricas reales de calibración sin simulación
...
## 12. Estado Final Consolidado

**Calibración:** POBRE
**ECE:** 0.5 (por encima de umbral 0.3)
**Truth source accuracy:** 0.400 (por debajo de umbral 0.6)
**Precision/Recall:** 0.6 (por debajo de umbral 0.7)
**Contradiction rate:** 0.471 (por encima de umbral 0.3)
**Accuracy bin 0.8-1.0:** 0.25 (sobreconfianza severa)

**Acción recomendada:** NO se puede mejorar calibración sin modificar TruthArbitrator (base estable congelada). Documentar ajustes recomendados para implementación futura.
